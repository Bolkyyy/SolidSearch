  ...
  return (
    ...
    <Layout>
          ...
          {activeTab === "users" && (
            <div className="settings-view-fade">
              <div className="view-header-row">
                ...
                <button className="create-collection-btn" onClick={() => setVisibleModalCreateUser(true)}>
                ...
                <tbody>
                  {users && users.map(user =>
                    <tr key={user.id}>
                      ...
                      <td>
                        <span className={`badge-status ${user.status == 'active' ? 'success' : 'danger'}`}>
      ...
      {isVisibleModalCreateUser && (
        <div className="modal-overlay" onClick={() => setVisibleModalCreateUser(false)}>
          <div className="modal-window" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>
                {modalMode === "add"
      ...
      {isVisibleModalEditUser && (
        <div className="modal-overlay" onClick={() => setVisibleModalEditUser(false)}>
          <div className="modal-window" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Редактирование пользователя</h2>
              <button className="modal-close" onClick={() => setVisibleModalEditUser(false)}>
                &times;
              </button>
            </div>
            ...
            <div className="modal-body">
              ...
              <div className="input-group-custom input-group-mb">
                <label className="block-title">Роль</label>
                <select className="dark-field-input" value={modalUserEditRole} onChange={(e) => setModalUserEditRole(e.target.value)}>
                  <option value="">Выберите роль</option>
                  <option value="admin">Администратор</option>
                  <option value="user">Пользователь</option>
                </select>
              ...
              <div className="input-group-custom input-group-mb">
                <label className="block-title">Статус</label>
                <select className="dark-field-input" value={modalUserEditStatus} onChange={(e) => setModalUserEditStatus(e.target.value)}>
                  <option value="">Выберите статус</option>
                  <option value="active">Активен</option>
                  <option value="blocked">Неактивен</option>
                </select>
