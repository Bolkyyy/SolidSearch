              ...
              <div key={item.id} className="activity-item multi-line">
                ...
                <div className="activity-row">
                  <span className="search-query" title={item.query_text}>
                    {item.query_type === "ai" ? (
                      <><i className="fa fa-magic" style={{ marginRight: 4, color: "#a78bfa" }} />AI: "</>
                    ) : (
                      <><i className="fa fa-search" style={{ marginRight: 4, color: "#60a5fa" }} />Поиск: "</>
                    )}
                  ...
                  {item.result_count != null && (
                    <span className="results-count">{item.result_count} рез.</span>
                  )}
                </div>
              </div>
            ))
