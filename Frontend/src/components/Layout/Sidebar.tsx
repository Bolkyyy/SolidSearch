  ...
  return (
    <aside className="sidebar">
      ...
      <Link to="/home" className={`nav-link ${path === '/home' ? 'active' : ''}`}>
        <div><i className="fa fa-home" /> Главная</div>
      </Link>
      <Link to="/search" className={`nav-link ${path === '/search' ? 'active' : ''}`}>
        <div><i className="fa fa-search" /> Поиск</div>
      </Link>
      <Link to="/collections" className={`nav-link ${path === '/collections' ? 'active' : ''}`}>
        <div><i className="fa fa-folder-open" /> Архив документов</div>
      </Link>
      <Link to="/history" className={`nav-link ${path === '/history' ? 'active' : ''}`}>
        <div><i className="fa fa-history" /> История запросов</div>
      </Link>
      <Link to="/analytics" className={`nav-link ${path === '/analytics' ? 'active' : ''}`}>
      ...
      <Link to="/settings" className={`nav-link ${path === '/settings' ? 'active' : ''}`}>
        <div><i className="fa fa-cog" /> Настройки</div>
      </Link>

      <div className="logout">
        <Link to="/login" className="exit"><i className="fa fa-sign-out" /> Выход</Link>
      </div>
    </aside>
  );
};
